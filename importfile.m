function accexp01user01 = importfile(filename, formatSpec, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   ACCEXP01USER01 = IMPORTFILE1(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   ACCEXP01USER01 = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   accexp01user01 = importfile1('acc_exp01_user01.txt', 1, 20598);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/02 17:09:05
...
accexp01user01 = [dataArray{1:end-1}];
